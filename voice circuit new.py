...
GEMINI_API_KEY = ''
genai.configure(api_key='AIzaSyBaOcBLjW-R2jSk_1HulsYGHjiaYCGu_mU')
...
def parse_command_with_gemini_v2(command):
    ...
    """
    # Dynamically build supported circuits section
    supported_circuits = ""
    for topology, params in metadata.items():
        param_list = ", ".join(params)
        supported_circuits += f"  * {topology}: parameters: {param_list}\n"
...
{supported_circuits}- Include component specifications appropriate for each topology
